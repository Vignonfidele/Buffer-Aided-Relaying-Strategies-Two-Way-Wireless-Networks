function [OUTC4]=Funtion_Com_duplo_Buffer_no_relay_Fonte_EF(n1,n2,n3,ptdb,P,Max,N) 
  OUTC4=[]; 
pt=10.^(ptdb/10); No=1; R=1; alpha=4; MaxR=2*Max; MaxS=Max; 
for d=n1:n3:n2  
d1=d; d2=1-d1;                                                               
