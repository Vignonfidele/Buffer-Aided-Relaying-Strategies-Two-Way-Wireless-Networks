function [OUTA2, OUTB2]=Funtion_Com_duplo_Buffer_no_relay(ptdb,Max) 
OUTA2=[]; OUTB2=[];
OutageA=0; OutageB=0;
    R=1;  No=1;
    N=2e6;
...
for P=700000:100000:1000000
    ...
    ContAR=0; ContBR=0;
    %ContAR= Posicion que ocupa los elementos A-->B em el buffer del relay, ContBR= Posicion que ocupa los elementos B-->A em el buffer del relay.                                                                              
    fA=0; fB=0; i=0; t=0; 
