...
d=n1:n3:n2;
subplot(1,2,1); semilogy(d,OUTA,'b','MarkerSize',5, 'LineWidth',1.25)
hold on
grid
...
Primero=semilogy(d,OUTB,'b','MarkerSize',5, 'LineWidth',1.25);
subplot(1,2,2); semilogy(d,OUTB,'b','MarkerSize',5, 'LineWidth',1.25)
hold on 
grid 
xticks([0.1 0.2 0.4 0.6 0.8 0.9])
yticks([7*10^-3 10^-2 10^-1 4*10^-1]); yticklabels({'7x10^-^3','10^-^2', '10^-^1', '4x10^-^1'})
...
d=n1:n3:n2;
subplot(1,2,1); semilogy(d,OUTA1,'r--','MarkerSize',5, 'LineWidth',1.25);
Secundo=semilogy(d,OUTA1,'r--','MarkerSize',5, 'LineWidth',1.25);
subplot(1,2,2); semilogy(d,OUTB1,'r--','MarkerSize',5, 'LineWidth',1.25);
%%
%Com buffer unico
[OUTA2,OUTB2]=Funtion_Com_duplo_Buffer_no_relay2(n1,n2,n3,ptdb,P+error,Max1,N);
subplot(1,2,1); semilogy(d,OUTA2,'g-.','MarkerSize',5, 'LineWidth',1.25);
tercero=semilogy(d,OUTA2,'g-.','MarkerSize',5, 'LineWidth',1.25);
subplot(1,2,2); semilogy(d,OUTB2,'g-.','MarkerSize',5, 'LineWidth',1.25);
%%
%Com buffer mo relay/fonte
[OUTA3, OUTB3]=Funtion_Com_Buffer_no_relay_Fonte2(n1,n2,n3,ptdb,P+error,Max1,N);
subplot(1,2,1); semilogy(d,OUTA3,'m','MarkerSize',5, 'LineWidth',1.25);
subplot(1,2,2); semilogy(d,OUTB3,'m','MarkerSize',5, 'LineWidth',1.25);
...
subplot(1,2,1); semilogy(d(numeco),OUTA3(numeco),'mv','MarkerSize',5, 'LineWidth',1.25);
subplot(1,2,2); semilogy(d(numeco),OUTB3(numeco),'mv','MarkerSize',5, 'LineWidth',1.25);

%%
%Com buffer mo relay/fonte
[OUTA4, OUTB4]=Funtion_Com_duplo_Buffer_no_relay_Fonte2(n1,n2,n3,ptdb,P+error,Max1,N);
subplot(1,2,1); semilogy(d,OUTA4,'c','MarkerSize',5, 'LineWidth',1.25);
subplot(1,2,2); semilogy(d,OUTB4,'c','MarkerSize',5, 'LineWidth',1.25);

numeco= ismembertol(d,0.1) | ismembertol(d,0.2) | ismembertol(d,0.3) | ismembertol(d,0.4) | ismembertol(d,0.5) | ismembertol(d,0.6) | ismembertol(d,0.7) | ismembertol(d,0.8) | ismembertol(d,0.9);
subplot(1,2,1); semilogy(d(numeco),OUTA4(numeco),'cs','MarkerSize',5, 'LineWidth',1.25);
subplot(1,2,2); semilogy(d(numeco),OUTB4(numeco),'cs','MarkerSize',5, 'LineWidth',1.25);
x1=0.01:0.001:0.01; y1=x1.^2;
x2=0.01:0.001:0.01; y2=x2.^3;
subplot(1,2,1); quarto=plot(x1,y1,'m-v','MarkerSize',5, 'LineWidth',1.25); 
subplot(1,2,2); Quinto=plot(x2,y2,'c-s','MarkerSize',5, 'LineWidth',1.25);
legend( [Primero; Secundo; tercero; quarto; Quinto],'Sem buffer', 'Buffer retransmissor', 'Buffer único retransmissor','Buffer retransmissor/fonte', 'Buffer único retransmissor/fonte')
